...
# ╔═╡ 5bcdfb2a-27c8-4850-bac5-d222f2e56168
begin
...
begin
	X_train = convert(Matrix{Float64}, X_train_raw)
	X_test = convert(Matrix{Float64}, X_test_raw)
	y_train = convert(Vector{Int}, y_train_raw)
...
[[deps.AdaptiveResonance]]
deps = ["Distributed", "LinearAlgebra", "Logging", "Parameters", "Printf", "ProgressBars", "SharedArrays", "Statistics"]
git-tree-sha1 = "4b7fc525898f38399bb1e44bf4576604135a650d"
